...
#define   AR_AREA_MIN                    500		// 原来是:70 Minimum area (in pixels) of connected regions considered valid candidate for marker detection.
