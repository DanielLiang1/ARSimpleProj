...
*/
//ARHandle      *arCreateHandle( ARParamLT *paramLT, ARMuValues *arMuValues);
...
// 得到MU数据
// int arIMUData(ARHandle *handle, MuValues wValues,MuValues aValues);
...
int arSetIMUData(ARIMUData *arIMUData,ARdouble *wData, ARdouble *aData);
