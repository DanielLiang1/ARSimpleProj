...
ARHandle *arCreateHandle( ARParamLT *paramLT )
{
    ...
    // 默认的labelingThreshMode		arSetLabelingThreshMode(handle, AR_LABELING_THRESH_MODE_AUTO_OTSU);
    handle->arLabelingThreshMode = -1;
  //  arSetLabelingThreshMode(handle, AR_LABELING_THRESH_MODE_DEFAULT);
	arSetLabelingThreshMode(handle, AR_LABELING_THRESH_MODE_AUTO_OTSU);
