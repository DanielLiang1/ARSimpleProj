...
bool AndroidVideoSource::getVideoReadyAndroid2(const ARParam *cparam_p) {
	...
	if (cparam_p) cparam = *cparam_p;
	    ...
	    ARController::logv("取默认值: Unable to automatically determine camera parameters. Using supplied default.\n");
        if (cameraParam) {
