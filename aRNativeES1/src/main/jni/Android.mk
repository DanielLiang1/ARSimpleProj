...
# 将AR的 .so库添加进来 .
ARC_DIR := $(MY_LOCAL_PATH)/../libs/c++/libs/armeabi-v7a
define add_arc_module
	include $(CLEAR_VARS)
	LOCAL_MODULE:=$1
...
ARC_LIBS := ARWrapper c++_shared
LOCAL_PATH := $(ARC_DIR)
$(foreach module,$(ARC_LIBS),$(eval $(call add_arc_module,$(module))))
...
LOCAL_STATIC_LIBRARIES += $(ARC_LIBS)
